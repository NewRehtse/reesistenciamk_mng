 ...
 */
final class Version20200321162322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tasks AS SELECT id, maker, thing, place, amount, delivery_type, extra, delivery_date, status, collect_address FROM tasks');
        ...
        $this->addSql('INSERT INTO tasks (id, maker, thing, place_id, amount, delivery_type, extra, delivery_date, status, collect_address) SELECT id, maker, thing, place, amount, delivery_type, extra, delivery_date, status, collect_address FROM __temp__tasks');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE tasks');
        $this->addSql('CREATE TABLE tasks (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, maker INTEGER DEFAULT NULL, thing INTEGER DEFAULT NULL, amount INTEGER NOT NULL, delivery_type INTEGER NOT NULL, extra VARCHAR(255) DEFAULT NULL, delivery_date DATE DEFAULT NULL, collect_address VARCHAR(255) DEFAULT NULL, status INTEGER NOT NULL, place INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO tasks (id, maker, thing, place, amount, delivery_type, extra, delivery_date, collect_address, status) SELECT id, maker, thing, place_id, amount, delivery_type, extra, delivery_date, collect_address, status FROM __temp__tasks');
        $this->addSql('DROP TABLE __temp__tasks');
        $this->addSql('CREATE INDEX IDX_50586597C6197FB4 ON tasks (maker)');
        $this->addSql('CREATE INDEX IDX_505865975B4C2C83 ON tasks (thing)');
