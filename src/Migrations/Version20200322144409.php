 ...
 */
final class Version20200322144409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__needs AS SELECT id, place_id, thing_id, amount, covered FROM needs');
        ...
        $this->addSql('INSERT INTO needs (id, need, thing_id, amount, covered) SELECT id, place_id, thing_id, amount, covered FROM __temp__needs');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE needs');
        $this->addSql('CREATE TABLE needs (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, thing_id INTEGER DEFAULT NULL, amount INTEGER NOT NULL, covered INTEGER DEFAULT NULL, place_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO needs (id, place_id, thing_id, amount, covered) SELECT id, need, thing_id, amount, covered FROM __temp__needs');
        $this->addSql('DROP TABLE __temp__needs');
        $this->addSql('CREATE INDEX IDX_6A59BEEEC36906A7 ON needs (thing_id)');
