 ...
 */
final class Version20200324202505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DA148550527EDB25');
        $this->addSql('DROP INDEX IDX_DA1485505B4C2C83');
        $this->addSql('CREATE TEMPORARY TABLE __temp__serialNumbers AS SELECT serial_number, thing, task FROM serialNumbers');
        $this->addSql('DROP TABLE serialNumbers');
        $this->addSql('CREATE TABLE serialNumbers (serial_number INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, thing INTEGER DEFAULT NULL, task INTEGER DEFAULT NULL, CONSTRAINT FK_DA1485505B4C2C83 FOREIGN KEY (thing) REFERENCES thing (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DA148550527EDB25 FOREIGN KEY (task) REFERENCES tasks (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO serialNumbers (serial_number, thing, task) SELECT serial_number, thing, task FROM __temp__serialNumbers');
        $this->addSql('DROP TABLE __temp__serialNumbers');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tasks AS SELECT id, maker, thing, place_id, amount, delivery_type, extra, collect_address, status FROM tasks');
        $this->addSql('DROP TABLE tasks');
        $this->addSql('CREATE TABLE tasks (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, maker INTEGER DEFAULT NULL, thing INTEGER DEFAULT NULL, place_id INTEGER DEFAULT NULL, amount INTEGER NOT NULL, delivery_type INTEGER NOT NULL, extra VARCHAR(255) DEFAULT NULL COLLATE BINARY, collect_address VARCHAR(255) DEFAULT NULL COLLATE BINARY, status INTEGER NOT NULL, CONSTRAINT FK_50586597C6197FB4 FOREIGN KEY (maker) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_505865975B4C2C83 FOREIGN KEY (thing) REFERENCES thing (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_50586597DA6A219 FOREIGN KEY (place_id) REFERENCES place (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO tasks (id, maker, thing, place_id, amount, delivery_type, extra, collect_address, status) SELECT id, maker, thing, place_id, amount, delivery_type, extra, collect_address, status FROM __temp__tasks');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tasks AS SELECT id, maker, thing, place_id, amount, delivery_type, extra, collect_address, status FROM tasks');
        $this->addSql('DROP TABLE tasks');
        $this->addSql('CREATE TABLE tasks (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, maker INTEGER DEFAULT NULL, thing INTEGER DEFAULT NULL, place_id INTEGER DEFAULT NULL, amount INTEGER NOT NULL, delivery_type INTEGER NOT NULL, extra VARCHAR(255) DEFAULT NULL, collect_address VARCHAR(255) DEFAULT NULL, status INTEGER NOT NULL, delivery_date DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO tasks (id, maker, thing, place_id, amount, delivery_type, extra, collect_address, status) SELECT id, maker, thing, place_id, amount, delivery_type, extra, collect_address, status FROM __temp__tasks');
        $this->addSql('DROP TABLE __temp__tasks');
        $this->addSql('CREATE INDEX IDX_50586597C6197FB4 ON tasks (maker)');
        $this->addSql('CREATE INDEX IDX_505865975B4C2C83 ON tasks (thing)');
