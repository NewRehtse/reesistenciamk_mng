 ...
 */
final class Version20200321151744 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6A59BEEE5B4C2C83');
        $this->addSql('DROP INDEX UNIQ_6A59BEEE741D53CD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__needs AS SELECT id, amount FROM needs');
        ...
        $this->addSql('INSERT INTO needs (id, amount) SELECT id, amount FROM __temp__needs');
        ...
        $this->addSql('CREATE TABLE tasks (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, maker INTEGER DEFAULT NULL, thing INTEGER DEFAULT NULL, place INTEGER DEFAULT NULL, amount INTEGER NOT NULL, delivery_type INTEGER NOT NULL, extra VARCHAR(255) DEFAULT NULL COLLATE BINARY, delivery_date DATE DEFAULT NULL, status INTEGER NOT NULL, CONSTRAINT FK_50586597C6197FB4 FOREIGN KEY (maker) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_505865975B4C2C83 FOREIGN KEY (thing) REFERENCES thing (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_50586597741D53CD FOREIGN KEY (place) REFERENCES place (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__needs AS SELECT id, amount FROM needs');
        $this->addSql('DROP TABLE needs');
        $this->addSql('CREATE TABLE needs (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, amount INTEGER NOT NULL, place INTEGER DEFAULT NULL, thing INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO needs (id, amount) SELECT id, amount FROM __temp__needs');
        $this->addSql('DROP TABLE __temp__needs');
